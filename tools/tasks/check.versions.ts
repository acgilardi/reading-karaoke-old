        ...
        exec('npm --version',
            function (error, stdout, stderr) {
                ...
                if (!semver.gte(stdout, VERSION_NPM)) {
                    reportError('NPM is not in required version! Required is ' + VERSION_NPM +
                        ' and you\'re using ' + stdout);
                }
            });
        ...
        exec('node --version',
            function (error, stdout, stderr) {
                ...
                if (!semver.gte(stdout, VERSION_NODE)) {
                    reportError('NODE is not in required version! Required is ' + VERSION_NODE +
                        ' and you\'re using ' + stdout);
                }
            });
    };
